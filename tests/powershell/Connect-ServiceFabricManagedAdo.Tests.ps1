...
.NOTES
    - Replace "Connect-ServiceFabricManagedAdo" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Connect-ServiceFabricManagedAdo.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Connect-ServiceFabricManagedAdo.ps1"
...
Describe "Connect-ServiceFabricManagedAdo" {
