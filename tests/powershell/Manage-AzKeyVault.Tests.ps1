...
.NOTES
    - Replace "Manage-AzKeyVault" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Manage-AzKeyVault.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\azure\Manage-AzKeyVault.ps1"
