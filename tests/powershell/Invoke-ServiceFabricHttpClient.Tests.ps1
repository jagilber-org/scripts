...
.NOTES
    - Replace "Invoke-ServiceFabricHttpClient" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Invoke-ServiceFabricHttpClient.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Invoke-ServiceFabricHttpClient.ps1"
...
Describe "Invoke-ServiceFabricHttpClient" {
