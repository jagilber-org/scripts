...
.NOTES
    - Replace "Update-MarkdownImage" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Update-MarkdownImage.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\utilities\Update-MarkdownImage.ps1"
