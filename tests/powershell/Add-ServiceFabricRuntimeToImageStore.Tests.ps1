...
.NOTES
    - Replace "Add-ServiceFabricRuntimeToImageStore" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Add-ServiceFabricRuntimeToImageStore.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Add-ServiceFabricRuntimeToImageStore.ps1"
...
Describe "Add-ServiceFabricRuntimeToImageStore" {
