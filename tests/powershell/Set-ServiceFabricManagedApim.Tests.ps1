...
.NOTES
    - Replace "Set-ServiceFabricManagedApim" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Set-ServiceFabricManagedApim.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Set-ServiceFabricManagedApim.ps1"
...
Describe "Set-ServiceFabricManagedApim" {
