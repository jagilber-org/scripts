...
.NOTES
    - Replace "Install-PreCommitHook" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Install-PreCommitHook.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\utilities\Install-PreCommitHook.ps1"
...
Describe "Install-PreCommitHook" {
