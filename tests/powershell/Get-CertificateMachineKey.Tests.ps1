...
.NOTES
    - Replace "Get-CertificateMachineKey" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Get-CertificateMachineKey.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\utilities\Get-CertificateMachineKey.ps1"
...
Describe "Get-CertificateMachineKey" {
