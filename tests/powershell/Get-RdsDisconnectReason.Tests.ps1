...
.NOTES
    - Replace "Get-RdsDisconnectReason" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Get-RdsDisconnectReason.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\utilities\Get-RdsDisconnectReason.ps1"
...
Describe "Get-RdsDisconnectReason" {
