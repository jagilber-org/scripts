...
.NOTES
    - Replace "Connect-AzRestApi" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Connect-AzRestApi.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\azure\Connect-AzRestApi.ps1"
