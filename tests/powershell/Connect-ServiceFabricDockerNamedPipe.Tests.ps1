...
.NOTES
    - Replace "Connect-ServiceFabricDockerNamedPipe" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Connect-ServiceFabricDockerNamedPipe.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Connect-ServiceFabricDockerNamedPipe.ps1"
...
Describe "Connect-ServiceFabricDockerNamedPipe" {
