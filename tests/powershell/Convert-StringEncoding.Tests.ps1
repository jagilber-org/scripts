...
.NOTES
    - Replace "Convert-StringEncoding" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Convert-StringEncoding.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\utilities\Convert-StringEncoding.ps1"
...
Describe "Convert-StringEncoding" {
