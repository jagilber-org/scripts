...
.NOTES
    - Replace "Watch-NetworkPort" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Watch-NetworkPort.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\utilities\Watch-NetworkPort.ps1"
