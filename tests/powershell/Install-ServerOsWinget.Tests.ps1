...
.NOTES
    - Replace "Install-ServerOsWinget" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Install-ServerOsWinget.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\utilities\Install-ServerOsWinget.ps1"
...
Describe "Install-ServerOsWinget" {
