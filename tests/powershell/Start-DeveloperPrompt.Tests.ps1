...
.NOTES
    - Replace "Start-DeveloperPrompt" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Start-DeveloperPrompt.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\utilities\Start-DeveloperPrompt.ps1"
...
Describe "Start-DeveloperPrompt" {
