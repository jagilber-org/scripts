...
.NOTES
    - Replace "Invoke-PerfMonAction" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Invoke-PerfMonAction.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\diagnostics\Invoke-PerfMonAction.ps1"
