...
.NOTES
    - Replace "New-AzKeyVaultCertificate" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\New-AzKeyVaultCertificate.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\azure\New-AzKeyVaultCertificate.ps1"
...
Describe "New-AzKeyVaultCertificate" {
