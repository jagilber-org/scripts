...
.NOTES
    - Replace "New-CertificateRequest" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\New-CertificateRequest.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\utilities\New-CertificateRequest.ps1"
...
Describe "New-CertificateRequest" {
