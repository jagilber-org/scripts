...
.NOTES
    - Replace "Start-ServiceFabricRealtimeTracing" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Start-ServiceFabricRealtimeTracing.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Start-ServiceFabricRealtimeTracing.ps1"
...
Describe "Start-ServiceFabricRealtimeTracing" {
