...
.NOTES
    - Replace "Import-EnvironmentFile" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Import-EnvironmentFile.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\automation\Import-EnvironmentFile.ps1"
...
Describe "Import-EnvironmentFile" {
