...
.NOTES
    - Replace "Connect-ServiceFabricCluster" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Connect-ServiceFabricCluster.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Connect-ServiceFabricCluster.ps1"
...
Describe "Connect-ServiceFabricCluster" {
