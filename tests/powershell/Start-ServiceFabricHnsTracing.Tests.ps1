...
.NOTES
    - Replace "Start-ServiceFabricHnsTracing" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Start-ServiceFabricHnsTracing.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Start-ServiceFabricHnsTracing.ps1"
...
Describe "Start-ServiceFabricHnsTracing" {
