...
.NOTES
    - Replace "Watch-ServiceFabricDocker" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Watch-ServiceFabricDocker.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Watch-ServiceFabricDocker.ps1"
...
Describe "Watch-ServiceFabricDocker" {
