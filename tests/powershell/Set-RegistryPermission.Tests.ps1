...
.NOTES
    - Replace "Set-RegistryPermission" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Set-RegistryPermission.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\utilities\Set-RegistryPermission.ps1"
...
Describe "Set-RegistryPermission" {
