...
.NOTES
    - Replace "Get-AzCostTrendAnalysis" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Get-AzCostTrendAnalysis.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\azure\Get-AzCostTrendAnalysis.ps1"
...
Describe "Get-AzCostTrendAnalysis" {
