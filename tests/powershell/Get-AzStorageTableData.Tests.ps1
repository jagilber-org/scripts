...
.NOTES
    - Replace "Get-AzStorageTableData" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Get-AzStorageTableData.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\azure\Get-AzStorageTableData.ps1"
...
Describe "Get-AzStorageTableData" {
