...
.NOTES
    - Replace "Test-HttpClientPort" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Test-HttpClientPort.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\utilities\Test-HttpClientPort.ps1"
