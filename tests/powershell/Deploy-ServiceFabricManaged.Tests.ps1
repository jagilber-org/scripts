...
.NOTES
    - Replace "Deploy-ServiceFabricManaged" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Deploy-ServiceFabricManaged.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Deploy-ServiceFabricManaged.ps1"
...
Describe "Deploy-ServiceFabricManaged" {
