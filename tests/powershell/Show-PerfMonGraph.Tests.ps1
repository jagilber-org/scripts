...
.NOTES
    - Replace "Show-PerfMonGraph" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Show-PerfMonGraph.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\diagnostics\Show-PerfMonGraph.ps1"
