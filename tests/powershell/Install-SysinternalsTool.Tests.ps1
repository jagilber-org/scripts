...
.NOTES
    - Replace "Install-SysinternalsTool" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Install-SysinternalsTool.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\utilities\Install-SysinternalsTool.ps1"
...
Describe "Install-SysinternalsTool" {
