...
.NOTES
    - Replace "Connect-ServiceFabricCtl" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Connect-ServiceFabricCtl.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Connect-ServiceFabricCtl.ps1"
...
Describe "Connect-ServiceFabricCtl" {
