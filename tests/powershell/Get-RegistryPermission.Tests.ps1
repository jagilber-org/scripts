...
.NOTES
    - Replace "Get-RegistryPermission" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Get-RegistryPermission.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\utilities\Get-RegistryPermission.ps1"
...
Describe "Get-RegistryPermission" {
