...
.NOTES
    - Replace "Remove-ServiceFabricDockerPlugin" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Remove-ServiceFabricDockerPlugin.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Remove-ServiceFabricDockerPlugin.ps1"
...
Describe "Remove-ServiceFabricDockerPlugin" {
