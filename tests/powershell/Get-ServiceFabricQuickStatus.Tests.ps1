...
.NOTES
    - Replace "Get-ServiceFabricQuickStatus" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Get-ServiceFabricQuickStatus.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Get-ServiceFabricQuickStatus.ps1"
...
Describe "Get-ServiceFabricQuickStatus" {
