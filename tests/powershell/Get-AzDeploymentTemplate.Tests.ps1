...
.NOTES
    - Replace "Get-AzDeploymentTemplate" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Get-AzDeploymentTemplate.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\azure\Get-AzDeploymentTemplate.ps1"
...
Describe "Get-AzDeploymentTemplate" {
