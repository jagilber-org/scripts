...
.NOTES
    - Replace "Invoke-ServiceFabricLinuxRest" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Invoke-ServiceFabricLinuxRest.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Invoke-ServiceFabricLinuxRest.ps1"
...
Describe "Invoke-ServiceFabricLinuxRest" {
