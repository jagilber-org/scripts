...
.NOTES
    - Replace "Get-ServiceFabricImageStore" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Get-ServiceFabricImageStore.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Get-ServiceFabricImageStore.ps1"
...
Describe "Get-ServiceFabricImageStore" {
