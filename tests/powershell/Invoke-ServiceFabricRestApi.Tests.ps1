...
.NOTES
    - Replace "Invoke-ServiceFabricRestApi" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Invoke-ServiceFabricRestApi.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Invoke-ServiceFabricRestApi.ps1"
...
Describe "Invoke-ServiceFabricRestApi" {
