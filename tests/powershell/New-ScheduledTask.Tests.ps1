...
.NOTES
    - Replace "New-ScheduledTask" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\New-ScheduledTask.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\automation\New-ScheduledTask.ps1"
