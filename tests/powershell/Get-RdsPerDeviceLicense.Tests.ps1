...
.NOTES
    - Replace "Get-RdsPerDeviceLicense" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Get-RdsPerDeviceLicense.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\utilities\Get-RdsPerDeviceLicense.ps1"
...
Describe "Get-RdsPerDeviceLicense" {
