...
.NOTES
    - Replace "Import-AzMetadataCertificate" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Import-AzMetadataCertificate.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\azure\Import-AzMetadataCertificate.ps1"
...
Describe "Import-AzMetadataCertificate" {
