...
.NOTES
    - Replace "Remove-RdsLicenseByClient" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Remove-RdsLicenseByClient.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\utilities\Remove-RdsLicenseByClient.ps1"
...
Describe "Remove-RdsLicenseByClient" {
