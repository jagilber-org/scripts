...
.NOTES
    - Replace "Start-DotNetTrace" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Start-DotNetTrace.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\diagnostics\Start-DotNetTrace.ps1"
