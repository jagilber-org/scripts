...
.NOTES
    - Replace "Update-ServiceFabricStandaloneManifest" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Update-ServiceFabricStandaloneManifest.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Update-ServiceFabricStandaloneManifest.ps1"
...
Describe "Update-ServiceFabricStandaloneManifest" {
