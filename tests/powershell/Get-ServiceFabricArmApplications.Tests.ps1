...
.NOTES
    - Replace "Get-ServiceFabricArmApplications" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Get-ServiceFabricArmApplications.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Get-ServiceFabricArmApplications.ps1"
...
Describe "Get-ServiceFabricArmApplications" {
