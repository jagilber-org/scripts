...
.NOTES
    - Replace "Publish-AzStorageFile" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Publish-AzStorageFile.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\azure\Publish-AzStorageFile.ps1"
...
Describe "Publish-AzStorageFile" {
