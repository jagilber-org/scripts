...
.NOTES
    - Replace "Start-ServiceFabricEtlTracing" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Start-ServiceFabricEtlTracing.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Start-ServiceFabricEtlTracing.ps1"
...
Describe "Start-ServiceFabricEtlTracing" {
