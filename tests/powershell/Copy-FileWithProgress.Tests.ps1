...
.NOTES
    - Replace "Copy-FileWithProgress" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Copy-FileWithProgress.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\utilities\Copy-FileWithProgress.ps1"
...
Describe "Copy-FileWithProgress" {
