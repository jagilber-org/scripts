...
.NOTES
    - Replace "Get-AzVmSkuAnalysisReport" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Get-AzVmSkuAnalysisReport.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\azure\Get-AzVmSkuAnalysisReport.ps1"
...
Describe "Get-AzVmSkuAnalysisReport" {
