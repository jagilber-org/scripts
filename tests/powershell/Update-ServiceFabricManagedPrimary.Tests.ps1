...
.NOTES
    - Replace "Update-ServiceFabricManagedPrimary" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Update-ServiceFabricManagedPrimary.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Update-ServiceFabricManagedPrimary.ps1"
...
Describe "Update-ServiceFabricManagedPrimary" {
