...
.NOTES
    - Replace "New-AzVmssSnapshot" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\New-AzVmssSnapshot.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\azure\New-AzVmssSnapshot.ps1"
