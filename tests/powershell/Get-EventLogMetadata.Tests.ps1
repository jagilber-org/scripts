...
.NOTES
    - Replace "Get-EventLogMetadata" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Get-EventLogMetadata.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\data-collection\Get-EventLogMetadata.ps1"
