...
.NOTES
    - Replace "Get-AzCostAnalysisReport" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Get-AzCostAnalysisReport.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\azure\Get-AzCostAnalysisReport.ps1"
...
Describe "Get-AzCostAnalysisReport" {
