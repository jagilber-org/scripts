...
.NOTES
    - Replace "New-ServiceFabricDevClusterSecure" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\New-ServiceFabricDevClusterSecure.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\New-ServiceFabricDevClusterSecure.ps1"
...
Describe "New-ServiceFabricDevClusterSecure" {
