...
.NOTES
    - Replace "Convert-EtlFile" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Convert-EtlFile.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\diagnostics\Convert-EtlFile.ps1"
