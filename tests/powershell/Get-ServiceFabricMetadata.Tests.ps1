...
.NOTES
    - Replace "Get-ServiceFabricMetadata" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Get-ServiceFabricMetadata.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Get-ServiceFabricMetadata.ps1"
...
Describe "Get-ServiceFabricMetadata" {
