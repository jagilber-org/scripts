...
.NOTES
    - Replace "Get-ServiceFabricDockerLog" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Get-ServiceFabricDockerLog.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Get-ServiceFabricDockerLog.ps1"
...
Describe "Get-ServiceFabricDockerLog" {
