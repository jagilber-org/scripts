...
.NOTES
    - Replace "Enable-AzVnetFlowLog" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Enable-AzVnetFlowLog.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\azure\Enable-AzVnetFlowLog.ps1"
