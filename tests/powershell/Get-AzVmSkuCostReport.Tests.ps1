...
.NOTES
    - Replace "Get-AzVmSkuCostReport" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Get-AzVmSkuCostReport.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\azure\Get-AzVmSkuCostReport.ps1"
...
Describe "Get-AzVmSkuCostReport" {
