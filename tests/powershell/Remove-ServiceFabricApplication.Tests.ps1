...
.NOTES
    - Replace "Remove-ServiceFabricApplication" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Remove-ServiceFabricApplication.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Remove-ServiceFabricApplication.ps1"
...
Describe "Remove-ServiceFabricApplication" {
