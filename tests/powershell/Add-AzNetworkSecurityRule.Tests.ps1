...
.NOTES
    - Replace "Add-AzNetworkSecurityRule" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Add-AzNetworkSecurityRule.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\azure\Add-AzNetworkSecurityRule.ps1"
...
Describe "Add-AzNetworkSecurityRule" {
