...
.NOTES
    - Replace "Clear-ServiceFabricDocker" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Clear-ServiceFabricDocker.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Clear-ServiceFabricDocker.ps1"
...
Describe "Clear-ServiceFabricDocker" {
