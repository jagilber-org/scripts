...
.NOTES
    - Replace "Install-KustoEmulator" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Install-KustoEmulator.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\data-collection\Install-KustoEmulator.ps1"
...
Describe "Install-KustoEmulator" {
