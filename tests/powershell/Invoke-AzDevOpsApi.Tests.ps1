...
.NOTES
    - Replace "Invoke-AzDevOpsApi" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Invoke-AzDevOpsApi.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\azure\Invoke-AzDevOpsApi.ps1"
