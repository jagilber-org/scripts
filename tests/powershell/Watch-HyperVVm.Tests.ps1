...
.NOTES
    - Replace "Watch-HyperVVm" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Watch-HyperVVm.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\automation\Watch-HyperVVm.ps1"
