...
.NOTES
    - Replace "Connect-ServiceFabricManaged" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Connect-ServiceFabricManaged.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Connect-ServiceFabricManaged.ps1"
...
Describe "Connect-ServiceFabricManaged" {
