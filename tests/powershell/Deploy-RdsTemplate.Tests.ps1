...
.NOTES
    - Replace "Deploy-RdsTemplate" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Deploy-RdsTemplate.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\utilities\Deploy-RdsTemplate.ps1"
