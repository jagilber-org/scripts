...
.NOTES
    - Replace "New-AzAadServicePrincipal" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\New-AzAadServicePrincipal.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\azure\New-AzAadServicePrincipal.ps1"
...
Describe "New-AzAadServicePrincipal" {
