...
.NOTES
    - Replace "Disable-ServiceFabricNode" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Disable-ServiceFabricNode.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Disable-ServiceFabricNode.ps1"
...
Describe "Disable-ServiceFabricNode" {
