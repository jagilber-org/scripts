...
.NOTES
    - Replace "Watch-ServiceFabricDockerPlugin" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Watch-ServiceFabricDockerPlugin.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Watch-ServiceFabricDockerPlugin.ps1"
...
Describe "Watch-ServiceFabricDockerPlugin" {
