...
.NOTES
    - Replace "Export-ServiceFabricArmTemplate" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Export-ServiceFabricArmTemplate.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Export-ServiceFabricArmTemplate.ps1"
...
Describe "Export-ServiceFabricArmTemplate" {
