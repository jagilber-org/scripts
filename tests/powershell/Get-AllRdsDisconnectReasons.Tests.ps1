...
.NOTES
    - Replace "Get-AllRdsDisconnectReasons" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Get-AllRdsDisconnectReasons.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\utilities\Get-AllRdsDisconnectReasons.ps1"
...
Describe "Get-AllRdsDisconnectReasons" {
