...
.NOTES
    - Replace "Manage-AzLoadBalancerRule" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Manage-AzLoadBalancerRule.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\azure\Manage-AzLoadBalancerRule.ps1"
...
Describe "Manage-AzLoadBalancerRule" {
