...
.NOTES
    - Replace "Set-ServiceFabricImageStoreSettings" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Set-ServiceFabricImageStoreSettings.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\service-fabric\Set-ServiceFabricImageStoreSettings.ps1"
...
Describe "Set-ServiceFabricImageStoreSettings" {
