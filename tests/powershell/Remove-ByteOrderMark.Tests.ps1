...
.NOTES
    - Replace "Remove-ByteOrderMark" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Remove-ByteOrderMark.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\utilities\Remove-ByteOrderMark.ps1"
