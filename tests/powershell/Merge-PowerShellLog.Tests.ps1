...
.NOTES
    - Replace "Merge-PowerShellLog" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Merge-PowerShellLog.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\data-collection\Merge-PowerShellLog.ps1"
