...
.NOTES
    - Replace "Add-AzVmssAppGateway" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Add-AzVmssAppGateway.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\azure\Add-AzVmssAppGateway.ps1"
