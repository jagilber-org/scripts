...
.NOTES
    - Replace "Test-RdsLicenseServer" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Test-RdsLicenseServer.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\utilities\Test-RdsLicenseServer.ps1"
...
Describe "Test-RdsLicenseServer" {
