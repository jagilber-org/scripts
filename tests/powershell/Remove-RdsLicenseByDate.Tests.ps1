...
.NOTES
    - Replace "Remove-RdsLicenseByDate" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Remove-RdsLicenseByDate.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\utilities\Remove-RdsLicenseByDate.ps1"
...
Describe "Remove-RdsLicenseByDate" {
