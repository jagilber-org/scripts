...
.NOTES
    - Replace "Find-AzImageBuild" with your script name
    - Customize test cases based on script functionality
    - Run tests: Invoke-Pester -Path .\tests\powershell\Find-AzImageBuild.Tests.ps1
#>

BeforeAll {
    # Import the script to test
    $scriptPath = Join-Path $PSScriptRoot "..\..\powershell\azure\Find-AzImageBuild.ps1"
