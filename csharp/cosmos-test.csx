...
Reason: ({"code":"Forbidden","message":"Request blocked by Auth your-account-name :
...
TestCosmosClientAsync: cosmosEndpoint=https://your-account-name.documents.azure.com, databaseName=your-database, managedIdentityClientId=xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
- VisualStudioCredential authentication failed: Visual Studio Token provider can't be accessed at C:\Users\your-username\AppData\Local\.IdentityService\AzureServiceAuth\tokenprovider.json
