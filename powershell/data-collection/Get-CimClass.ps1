...
.DESCRIPTION
    Enumerates CIM classes in a specified namespace, optionally filtering by class name pattern.
    Returns matching class names and logs results to a file.

.NOTES
   File Name  : enum-cim.ps1
   Author     : jagilber
   Version    : 1.0.0
   Changelog  : 1.0.0 - Version normalization from 160612 (constitution quality-007/008/009)
