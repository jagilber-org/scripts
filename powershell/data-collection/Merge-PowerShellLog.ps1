...
.DESCRIPTION
    Merges multiple PowerShell log CSV files with timestamps into a single chronologically
    ordered output file. Supports date range filtering and subdirectory searching.
