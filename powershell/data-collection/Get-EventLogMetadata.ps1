...
.DESCRIPTION
    ...
    Enumerates all event logs and exports metadata for each event log to individual CSV files.
    Optionally enables or disables debug and analytic event logs on local or remote machines.
    Supports regex filter patterns for event log names.
