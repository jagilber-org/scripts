...
.DESCRIPTION
    Updates Azure Service Fabric cluster settings (fabric settings) via ARM.
    Supports JSON or hashtable input for setting configuration parameters.

.NOTES

    File Name  : Set-ServiceFabricSettings.ps1
