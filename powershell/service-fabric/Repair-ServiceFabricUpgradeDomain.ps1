...
.DESCRIPTION
    Forces recovery of a Service Fabric VMSS platform update domain walk.
    Run on all update domains until no pending update error is returned.

.NOTES

    File Name  : Repair-ServiceFabricUpgradeDomain.ps1
...
.EXAMPLE
    .\Repair-ServiceFabricUpgradeDomain.ps1 -resourceGroup 'myRG' -vmssName 'nt0'
.FUNCTIONALITY
