<#
.SYNOPSIS
    Deploys a Service Fabric managed cluster using PowerShell.

.DESCRIPTION
    Creates a new Service Fabric managed cluster with the specified configuration.
    Supports standard and basic SKU clusters with certificate-based security.

.NOTES

    File Name  : Deploy-ServiceFabricManaged.ps1
...
.EXAMPLE
    .\Deploy-ServiceFabricManaged.ps1 -resourceGroup 'myRG' -adminPassword 'P@ss' -thumbprint '<thumbprint>' -location 'eastus'
#>
