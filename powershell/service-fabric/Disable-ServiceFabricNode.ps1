<#
.SYNOPSIS
    Disables a Service Fabric node using the SF REST API.

.DESCRIPTION
    Sends a disable node request to the Service Fabric cluster REST API endpoint
    using certificate-based authentication. Useful for putting nodes into maintenance.

.NOTES

    File Name  : Disable-ServiceFabricNode.ps1
...
.EXAMPLE
    .\Disable-ServiceFabricNode.ps1 -gatewayHost 'https://localhost:19080' -gatewayCertThumb '<thumbprint>' -nodeName '_nt0_0'
