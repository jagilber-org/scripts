...
.DESCRIPTION
    Downloads Service Fabric runtime CAB packages and extracts manifest (.man) files
    for use with ETL trace parsing tools.

.NOTES

    File Name  : Get-ServiceFabricCab.ps1
