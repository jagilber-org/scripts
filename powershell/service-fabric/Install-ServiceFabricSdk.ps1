...
.DESCRIPTION
    Installs the Web Platform Installer and Service Fabric SDK if not already present.
    Downloads WebPI and uses it to install the Service Fabric SDK components.

.NOTES

    File Name  : Install-ServiceFabricSdk.ps1
