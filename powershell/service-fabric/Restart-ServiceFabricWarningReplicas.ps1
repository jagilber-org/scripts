...
.DESCRIPTION
    Restarts stateful replicas or removes stateless replicas that are in a warning health state.

.NOTES

    File Name  : Restart-ServiceFabricWarningReplicas.ps1
...
.EXAMPLE
    .\Restart-ServiceFabricWarningReplicas.ps1

.EXAMPLE
    .\Restart-ServiceFabricWarningReplicas.ps1 -whatIf
