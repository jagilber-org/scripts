...
.DESCRIPTION
    Enumerates cluster nodes, applications, services, partitions, and replicas.
    Reports health state for each object. Useful when Service Fabric Explorer is unavailable.

.NOTES

    File Name  : Get-ServiceFabricQuickStatus.ps1
