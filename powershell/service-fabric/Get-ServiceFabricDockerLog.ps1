...
.DESCRIPTION
    Monitors Docker log files (.err and .out) generated by Service Fabric container
    activation. Tails the log files in a loop with configurable interval.

.NOTES

    File Name  : Get-ServiceFabricDockerLog.ps1
...
.EXAMPLE
    .\Get-ServiceFabricDockerLog.ps1 -tailLength 500
.LINK
