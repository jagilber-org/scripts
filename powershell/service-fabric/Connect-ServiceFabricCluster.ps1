...
.DESCRIPTION
    Connects to a Service Fabric cluster using certificate-based authentication.
    Supports both thumbprint and common name based certificate lookup.

.NOTES

    File Name  : Connect-ServiceFabricCluster.ps1
...
.EXAMPLE
    .\Connect-ServiceFabricCluster.ps1 -clusterEndpoint 'mycluster.eastus.cloudapp.azure.com' -thumbprint '<thumbprint>'
