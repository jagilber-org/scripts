...
.DESCRIPTION
    Searches for the VMSS that corresponds to a Service Fabric node type by comparing
    the cluster endpoint and SF extension properties across all scale sets in the resource group.

.NOTES

    File Name  : Find-ServiceFabricNodeType.ps1
