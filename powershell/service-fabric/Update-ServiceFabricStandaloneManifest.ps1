...
.DESCRIPTION
    Updates a standalone Service Fabric cluster manifest file. Replaces the current
    manifest with a new one and triggers a cluster configuration upgrade.

.NOTES

    File Name  : Update-ServiceFabricStandaloneManifest.ps1
...
.EXAMPLE
    .\Update-ServiceFabricStandaloneManifest.ps1 -newManifest '.\ClusterManifest.new.xml'
