...
.NOTES
Version    : 1.0.0
    Changelog  : 1.0.0 - Version normalization from 25/02/04 (constitution quality-007/008/009)
...
.EXAMPLE
./sf-managed-connect.ps1 -clusterEndpoint "mycluster.sfmc.azclient.ms" -thumbprint "ABCDEF1234567890ABCDEF1234567890ABCDEF12" -resourceGroup "MyResourceGroup" # pii-allowlist

.EXAMPLE
./sf-managed-connect.ps1 -clusterEndpoint "mycluster.sfmc.azclient.ms:19000" -thumbprint "ABCDEF1234567890ABCDEF1234567890ABCDEF12" -resourceGroup "MyResourceGroup" -domainNameLabelScope # pii-allowlist

.EXAMPLE
./sf-managed-connect.ps1 -clusterEndpoint "mycluster.sfmc.azclient.ms" -findType "FindBySubjectName" -findValue "mycluster.sfmc.azclient.ms" -thumbprint "ABCDEF1234567890ABCDEF1234567890ABCDEF12" -resourceGroup "MyResourceGroup # pii-allowlist
