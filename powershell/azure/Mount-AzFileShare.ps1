...
.DESCRIPTION
    Maps a network drive to an Azure Storage file share using credentials or
    a storage account key. Validates TCP connectivity on port 445 before mapping.

.NOTES

    File Name  : Mount-AzFileShare.ps1
...
.EXAMPLE
    .\Mount-AzFileShare.ps1 -password '<key>' -storageAccount 'mystorageaccount' -fileShare 'myshare'
.LINK
