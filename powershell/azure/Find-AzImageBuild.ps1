...
.DESCRIPTION
    Matches a local or specified Windows OS build number against available Azure VM image SKUs.
    Queries Azure Marketplace for matching images by publisher, offer, and SKU pattern.
    Useful for finding the correct Azure image to match on-premises OS versions.

.NOTES
    File Name  : azure-az-image-build-match.ps1
    Author     : jagilber
    Version    : 1.0.0
    Changelog  : 1.0.0 - Version normalization from 200801 (constitution quality-007/008/009)
.EXAMPLE
