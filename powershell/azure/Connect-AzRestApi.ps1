...
.DESCRIPTION
    Authenticates to Azure Resource Manager, ASM, or Graph REST APIs using a certificate
    or client secret. Stores the bearer token in $global:token for use with Invoke-AzRestQuery.

.NOTES

    File Name  : Connect-AzRestApi.ps1
...
.EXAMPLE
    .\Connect-AzRestApi.ps1 -thumbPrint 'ABC123' -clientId '1950a258-227b-4e31-a9cf-717495945fc2' -tenantId 'contoso.onmicrosoft.com'
