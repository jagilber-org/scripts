<#
.SYNOPSIS
    Enumerates available VM OS images from Azure Marketplace.

.DESCRIPTION
    Queries the Azure Marketplace for VM images by location, publisher, offer, and SKU.
    Returns image details including version information. Supports filtering and detailed output.

.NOTES

    File Name  : Get-AzVmImage.ps1
...
.EXAMPLE
    .\Get-AzVmImage.ps1 -location 'eastus' -publisher 'MicrosoftWindowsServer' -offer 'WindowsServer'
