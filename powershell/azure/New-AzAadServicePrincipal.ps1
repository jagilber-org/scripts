...
.DESCRIPTION
    Creates an Azure Active Directory application registration and service principal
    for certificate-based or key-based authentication. Generates a self-signed certificate
    if needed and configures the SPN with the specified credentials.

.NOTES

    File Name  : New-AzAadServicePrincipal.ps1
