...
.DESCRIPTION
    Uploads local files and folder structures to an Azure Blob Storage container.
    Creates the resource group, storage account, and container if they do not exist.
    Returns a SAS URL for accessing the uploaded data.

.NOTES

    File Name  : Publish-AzStorageFile.ps1
...
.EXAMPLE
    ...
    example $path: C:\temp\fabriclogs-00000000-0000-0000-0000-000000000000
    example file: C:\temp\fabriclogs-00000000-0000-0000-0000-000000000000\_nt0_1\Fabric\d8511df4d4a1fb61dd6b829752e17ac5_fabric_traces_9.0.1048.9590_133033481041665715_36_00637946569006952231_0000000000.dtr
