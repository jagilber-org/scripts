...
.DESCRIPTION
    ...
    $sas = "https://sflogsxxxxxxxxxxxxxx.table.core.windows.net/?sv=2017-11-09&ss=bfqt&srt=sco&sp=rwdlacup&se=2018-09-30T09:27:56Z&st=2018-09-30T01:27:56Z&spr=https&sig=4SfN%2Fza0c1CXop6sKQkFf0f8thKDUBYK7xQ%3D" # pii-allowlist
...
.NOTES
    ...
    Author     : jagilber
    Version    : 1.0.0
    Changelog  : 1.0.0 - Version normalization from 181102 original (constitution quality-007/008/009)
.EXAMPLE
    .\azure-storage-query-table.ps1 -saskeyTable $sas `
