<#
.SYNOPSIS
    Invokes Azure DevOps REST API endpoints using a Personal Access Token (PAT).

.DESCRIPTION
    Sends authenticated requests to the Azure DevOps REST API. Supports querying
    projects, repositories, builds, releases, and other Azure DevOps resources.
    Uses PAT-based Basic authentication.

.NOTES

    File Name  : Invoke-AzDevOpsApi.ps1
...
.EXAMPLE
    .\Invoke-AzDevOpsApi.ps1 -organization 'myOrg' -project 'myProject' -pat '<pat>'
#>
