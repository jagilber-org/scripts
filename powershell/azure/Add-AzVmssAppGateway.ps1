<#
.SYNOPSIS
    Adds an Application Gateway to an existing Service Fabric VMSS deployment.

.DESCRIPTION
    Creates and configures an Azure Application Gateway with a dedicated subnet,
    then associates it with the specified VMSS backend pool. Requires an existing
    resource group, virtual network, and VM scale set.

.NOTES

    File Name  : Add-AzVmssAppGateway.ps1
...
.EXAMPLE
    .\Add-AzVmssAppGateway.ps1 -resourceGroupName 'myRG' -vmssName 'nt0'
#>
