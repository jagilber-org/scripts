<#
.SYNOPSIS
    Exports ARM deployment templates, parameters, and operations from an Azure subscription.

.DESCRIPTION
    Iterates through resource groups in the current subscription and exports all deployment
    templates and parameters to JSON files. Optionally uses Git to track changes between runs.

.NOTES

    File Name  : Get-AzDeploymentTemplate.ps1
...
.EXAMPLE
    .\Get-AzDeploymentTemplate.ps1 -resourceGroups 'myRG1','myRG2' -outputDir 'C:\temp\templates'
