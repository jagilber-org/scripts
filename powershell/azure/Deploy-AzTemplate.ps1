...
.NOTES
   ...
   Version    : 1.0.0
   Changelog  : 1.0.0 - Version normalization from 200924 fix for serialization bug in cmdlet (constitution quality-007/008/009)
...
.EXAMPLE
    .\azure-az-deploy-template.ps1 -adminPassword '<strong-password>' -resourceGroup rdsdeptest
