...
.NOTES
   ...
   Author     : jagilber
   Version    : 1.0.0
   Changelog  : 1.0.0 - Version normalization from 150618 (constitution quality-007/008/009)
.EXAMPLE
    .\Invoke-PerfMonAction.ps1
    Monitors the total CPU processor time and runs start/stop commands when sustained threshold is reached.
#>
