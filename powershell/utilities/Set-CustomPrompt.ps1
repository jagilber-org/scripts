...
.DESCRIPTION
    Configures a custom PowerShell prompt with Git branch awareness, stash count, and execution time display.

.NOTES

    File Name  : Set-CustomPrompt.ps1
...
.EXAMPLE
    . .\Set-CustomPrompt.ps1
    Dot-sources the script to activate the custom prompt in the current session.
