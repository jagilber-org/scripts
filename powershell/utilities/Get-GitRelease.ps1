...
.DESCRIPTION
    Downloads release assets from a GitHub repository using the GitHub Releases API. Supports downloading the latest release or all releases.

.NOTES

    File Name  : Get-GitRelease.ps1
...
.EXAMPLE
    .\Get-GitRelease.ps1 -owner 'microsoft' -repository 'winget-cli' -latest
    Downloads the latest release from the microsoft/winget-cli repository.
