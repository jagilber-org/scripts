...
.DESCRIPTION
    Captures network traffic using ETW trace sessions for a specified amount of time. Supports configurable trace file size, session naming, and network provider selection.

.NOTES

    File Name  : Start-NetworkTrace.ps1
