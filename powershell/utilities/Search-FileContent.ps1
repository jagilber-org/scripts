<#
.SYNOPSIS
    Searches files for regex patterns with optional replacement.

.DESCRIPTION
    Searches (greps) files in a given path for a regex pattern and optionally replaces matches with a new string. Supports subdirectory recursion and backup creation.

.NOTES

    File Name  : Search-FileContent.ps1
