...
.NOTES
    ...
    Changelog  : 1.0.0 - Version normalization from 160520 original (constitution quality-007/008/009)
.EXAMPLE
.\rds-upd-mgr.ps1 -user jagilber
    .\rds-upd-mgr.ps1 -sid S-1-5-21-124525095-708259637-1543119021-1234567 # pii-allowlist
