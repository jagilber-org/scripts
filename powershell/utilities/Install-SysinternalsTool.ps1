<#
.SYNOPSIS
    Downloads Sysinternals utilities.

.DESCRIPTION
    Downloads specified Sysinternals utilities from the Sysinternals Live site for local use.

.NOTES

    File Name  : Install-SysinternalsTool.ps1
...
.EXAMPLE
    .\Install-SysinternalsTool.ps1 -sysinternalsExe 'procdump.exe'
    Downloads procdump.exe from Sysinternals.
