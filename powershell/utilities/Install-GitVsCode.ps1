<#
.SYNOPSIS
    Sets up Git, GitHub CLI, PowerShell 7, and VS Code.

.DESCRIPTION
    Installs and configures Git, GitHub CLI, PowerShell 7, and VS Code with common extensions and git configuration settings.

.NOTES

    File Name  : Install-GitVsCode.ps1
...
.EXAMPLE
    .\Install-GitVsCode.ps1 -user 'myuser' -email 'me@example.com'
    Sets up the full development environment with the specified Git identity.
#>
