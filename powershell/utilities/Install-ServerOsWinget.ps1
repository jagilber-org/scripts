...
.DESCRIPTION
    Installs WinGet package manager on Windows Server 2022 with required XAML and VCLibs dependencies for installing tools like WinDbg.

.NOTES

    File Name  : Install-ServerOsWinget.ps1
...
.EXAMPLE
    .\Install-ServerOsWinget.ps1
    Installs WinGet with default settings on Windows Server 2022.
#>
