...
.DESCRIPTION
    Microsoft Graph REST API script for querying and managing Azure AD resources. Supports device code, client credentials, and authorization code grant types.

.EXAMPLE
    .\Invoke-GraphApi.ps1 -query 'users'
    Queries the users endpoint via Microsoft Graph API.
...
param(
    ...
    $clientId = '14d82eec-204b-4c2f-b7e8-296a70dab67e', # well-known Azure AD PowerShell client ID (public, first-party)
    $clientSecret,
