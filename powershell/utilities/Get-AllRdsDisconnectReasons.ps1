<#
.SYNOPSIS
    Enumerates all RDS client disconnect reason codes.

.DESCRIPTION
    Retrieves all Remote Desktop Services client disconnect reason codes and friendly descriptions using the MSTscAx COM object and writes them to a file.

.NOTES

    File Name  : Get-AllRdsDisconnectReasons.ps1
...
.EXAMPLE
    .\Get-AllRdsDisconnectReasons.ps1
    Enumerates all disconnect codes and saves them to c:\temp\clientcodes.txt.
#>
