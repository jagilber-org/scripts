<#
.SYNOPSIS
    Deploys and manages UMDH for memory leak diagnostics.

.DESCRIPTION
    Deploys and manages the User-Mode Dump Heap (UMDH) tool for memory leak diagnostics on Terminal Services processes.

.NOTES

    File Name  : Start-UmdhTask.ps1
...
.EXAMPLE
    .\Start-UmdhTask.ps1
    Deploys UMDH and begins tracking memory allocations.
#>
