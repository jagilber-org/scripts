...
.NOTES
   ...
   Version    : 1.0.0
   Changelog  : 1.0.0 - Version normalization from 170825 v1.0 (constitution quality-007/008/009)

.EXAMPLE
    .\deploy-rds-templates.ps1 -adminPassword '<strong-password>' -resourceGroup rdsdeptest -location eastus -installOptions rds-deployment-uber
...
.EXAMPLE
    .\deploy-rds-templates.ps1 -adminPassword '<strong-password>' -resourceGroup rdsdeptest -admin cloudadmin -numberOfRdshInstances 5 -rdshVmSize Standard_A4 -imagesku 2012-r2-Datacenter -installOptions rds-deployment -location westus
...
.EXAMPLE
    .\deploy-rds-templates.ps1 -adminPassword '<strong-password>' -resourceGroup rdsdeptest -monitor -postConnect -location eastus
...
param(
    ...
    [string]$deployFileAdDeployment = "https://raw.githubusercontent.com/Azure/azure-quickstart-templates/bb24e0c10dd73b818dc492133522ceaf72887cd5/active-directory-new-domain/azuredeploy.json", # pii-allowlist
