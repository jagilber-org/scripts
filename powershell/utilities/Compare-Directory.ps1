<#
.SYNOPSIS
    Compares file information between two directories.

.DESCRIPTION
    Compares file hashes, versions, and metadata between two directories and reports differences. Saves file information to JSON files for review.

.NOTES

    File Name  : Compare-Directory.ps1
...
.EXAMPLE
    .\Compare-Directory.ps1 -directory1 'C:\DirA' -directory2 'C:\DirB'
    Compares files in DirA and DirB and outputs differences.
#>
