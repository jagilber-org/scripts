...
.DESCRIPTION
    Prompts for two dates and calculates the time difference in days, hours, minutes, seconds, and milliseconds.

.NOTES

    File Name  : Get-TimeDifference.ps1
...
.EXAMPLE
    ...
    Prompts for beginning and end dates, then displays the time difference.
#>
