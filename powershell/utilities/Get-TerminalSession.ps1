<#
.SYNOPSIS
    Queries RDP and terminal session information.

.DESCRIPTION
    Retrieves terminal session details including username, client name, IP address, and session state via P/Invoke of wtsapi32.dll.

.NOTES

    File Name  : Get-TerminalSession.ps1
...
.EXAMPLE
    .\Get-TerminalSession.ps1
    Lists all active terminal sessions on the local machine.
#>
