<#
.SYNOPSIS
    Monitors network ports on a schedule.

.DESCRIPTION
    Monitors network ports, handles, and processes on a configurable schedule and logs results to timestamped files.

.NOTES

    File Name  : Watch-NetworkPort.ps1
...
.EXAMPLE
    .\Watch-NetworkPort.ps1 -intervalMinutes 5 -endTime (Get-Date).AddHours(4)
    Monitors network ports every 5 minutes for 4 hours.
#>
