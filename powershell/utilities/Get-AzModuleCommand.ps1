<#
.SYNOPSIS
    Scans scripts for Azure Az module commands.

.DESCRIPTION
    Scans PowerShell scripts for Azure Az commands to determine which Azure modules are needed. Supports scanning individual files or entire directories.

.NOTES

    File Name  : Get-AzModuleCommand.ps1
...
.EXAMPLE
    .\Get-AzModuleCommand.ps1 -scriptDir 'C:\scripts'
    Scans all scripts in the directory for Azure Az commands.
#>
