<#
.SYNOPSIS
    Searches for and optionally replaces GUIDs in files.

.DESCRIPTION
    Searches files for GUIDs using regex pattern matching and optionally replaces them with new GUIDs, maintaining a consistent mapping. Supports creating backups and WhatIf mode.

.NOTES

    File Name  : New-GuidBatch.ps1
