...
This directory contains 61 general-purpose PowerShell scripts organized by functional area.
...
### Installation & Setup (3 scripts)
- **Install-Mirantis.ps1** - Install Mirantis Container Runtime
- **Install-ServerOsWinget.ps1** - Install Windows Package Manager on Server OS

### System Configuration (2 scripts)
- **Set-DesktopHeap.ps1** - Configure desktop heap size
- **Set-VmssCseTls.ps1** - Configure TLS for VMSS Custom Script Extension
