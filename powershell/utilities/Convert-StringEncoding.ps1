<#
.SYNOPSIS
    Converts strings between various encodings.

.DESCRIPTION
    Converts strings between Base64, URL-encode, regex escape, character arrays, and RSA encrypt/decrypt formats.

.NOTES

    File Name  : Convert-StringEncoding.ps1
...
.EXAMPLE
    .\Convert-StringEncoding.ps1 -inputString 'Hello' -stringToBase64
