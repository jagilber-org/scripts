<#
.SYNOPSIS
    TCP client/server test tool for connectivity troubleshooting.

.DESCRIPTION
    Starts a TCP listener or connects as a TCP client to troubleshoot network connectivity issues.

.NOTES

    File Name  : Test-TcpListener.ps1
...
.EXAMPLE
    .\Test-TcpListener.ps1 -port 9999
    Starts a TCP listener on port 9999.
#>
